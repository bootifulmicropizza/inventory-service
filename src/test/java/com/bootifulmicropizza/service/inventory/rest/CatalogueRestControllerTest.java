...
public class CatalogueRestControllerTest {
    ...
    public void setUp() {
        ...
        when(catalogueRepository.findOne(1L)).thenReturn(catalogue);
    ...
    public void getSingleCatalogue() throws Exception {
        ...
        verify(catalogueRepository, times(1)).findOne(1L);
    }
    ...
    public void getSingleCatalogueThatDoesNotExist() throws Exception {
        ...
        verify(catalogueRepository, times(1)).findOne(2L);
    }
    ...
    public void updateSingleCatalogue() throws Exception {
        when(catalogueRepository.exists(1L)).thenReturn(true);
    ...
    public void updateSingleCatalogueThatDoesNotExist() throws Exception {
        when(catalogueRepository.exists(1L)).thenReturn(false);
        ...
        verify(catalogueRepository, times(1)).exists(1L);
    }
    ...
    public void deleteSingleCatalogue() throws Exception {
        ...
        verify(catalogueRepository, times(1)).delete(1L);
    }
}
